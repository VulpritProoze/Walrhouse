 ...
 *
 * @remarks
 * A separate instance is intentional: the main `lib/axios` instance will later
 * have a response interceptor that automatically calls {@link refresh} on 401s.
 * If `refresh` itself used that same instance, a failed refresh would trigger
 * an infinite loop. This instance has NO such interceptor.
 */
 ...
 */
export const register = (data: RegisterRequest) => authApi.post<void>('api/Users/register', data);
...
export const refresh = (data: RefreshRequest) =>
  authApi.post<RefreshResponse>('api/Users/refresh', data);
...
export const confirmEmail = (data: ConfirmEmailRequest) =>
  authApi.post<void>('api/Users/confirmEmail', data);
...
export const resendConfirmationEmail = (data: ResendConfirmationEmailRequest) =>
  authApi.post<void>('api/Users/resendConfirmationEmail', data);
...
export const forgotPassword = (data: ForgotPasswordRequest) =>
  authApi.post<void>('api/Users/forgotPassword', data);
...
export const resetPassword = (data: ResetPasswordRequest) =>
  authApi.post<void>('api/Users/resetPassword', data);
...
export const manageTwoFactor = (data?: TwoFactorRequest) =>
  data
    ? authApi.post<TwoFactorResponse>('api/Users/manage/2fa', data)
    : authApi.get<TwoFactorResponse>('api/Users/manage/2fa');
 ...
 */
export const getManageInfo = () => authApi.get<ManageInfoResponse>('api/Users/manage/info');
...
export const updateManageInfo = (data: UpdateInfoRequest) =>
  authApi.post<UpdateInfoResponse>('api/Users/manage/info', data);
