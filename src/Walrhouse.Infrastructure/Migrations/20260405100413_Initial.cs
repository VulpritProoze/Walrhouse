        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UgpEntry = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    BaseUoM = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_UoMGroups_UgpEntry", x => x.UgpEntry);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_UoMGroups_UgpEntry",
                        column: x => x.UgpEntry,
                        principalTable: "UoMGroups",
                        principalColumn: "UgpEntry",
                        onDelete: ReferentialAction.Cascade);
                });
