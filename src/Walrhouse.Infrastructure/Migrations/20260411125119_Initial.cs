        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressStateOrProvince = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    AddressPostalCode = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    AddressCountry = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UoMGroupLines = table.Column<string>(type: "jsonb", nullable: true),
                    BaseUoM = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehouseName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Warehouses_WarehouseCode", x => x.WarehouseCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemGroup = table.Column<int>(type: "integer", maxLength: 128, nullable: true),
                    UoMGroupId = table.Column<int>(type: "integer", maxLength: 64, nullable: false),
                    BarcodeValue = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    BarcodeFormat = table.Column<int>(type: "integer", maxLength: 64, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BinNo = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    BinName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    WarehouseCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Bins_BinNo", x => x.BinNo);
                    table.ForeignKey(
                        name: "FK_Bins_Warehouses_WarehouseCode",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Batches_Bins_BinNo",
                        column: x => x.BinNo,
                        principalTable: "Bins",
                        principalColumn: "BinNo",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "BarcodeHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BarcodeValue = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    BatchNumber = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarcodeHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BarcodeHistories_Batches_BatchId",
                        column: x => x.BatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarcodeHistories_BatchId",
                table: "BarcodeHistories",
                column: "BatchId");
