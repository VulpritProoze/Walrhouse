...
export const BatchMasterList = () => {
  const mockBatches = [
    { id: 'BAT-001', itemCode: 'ITEM-A', quantity: 100, receivedDate: '2024-04-01', status: 'Pending' },
    { id: 'BAT-002', itemCode: 'ITEM-B', quantity: 50, receivedDate: '2024-04-02', status: 'Completed' },
  ];
